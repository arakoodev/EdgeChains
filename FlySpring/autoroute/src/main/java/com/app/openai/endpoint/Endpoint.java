...
public class Endpoint {
    ...
    public String toString() {
        return "Endpoint{url='" + this.url + "', apiKey='" + this.apiKey + "', retryPolicy=" + this.retryPolicy + ", model='" + this.model + "', role='" + this.role + "', temperature=" + this.temperature + ", llmProvider=" + this.llmProvider + "}";
    }
}