...
public class Llama2Controller {
  ...
  public Single<List<String>> getChatCompletion(@RequestBody LLamaQuickstart endpoint, ArkRequest arkRequest) {

    System.out.println("\nI'm in controller class within get request\n");
...
//            .build();
    ...
    EdgeChain<List<String>> edgeChain =
        llama2Client.createGetChatCompletion(endpoint, arkRequest);
