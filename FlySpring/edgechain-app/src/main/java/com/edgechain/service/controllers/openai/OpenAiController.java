...
public class OpenAiController {
    ...
    public Single<ChatCompletionResponse> chatCompletion(@RequestBody OpenAiChatEndpoint openAiEndpoint) {
    ...
    public Single<OpenAiEmbeddingResponse> embeddings(@RequestBody OpenAiEmbeddingEndpoint openAiEndpoint)
            throws SQLException {
