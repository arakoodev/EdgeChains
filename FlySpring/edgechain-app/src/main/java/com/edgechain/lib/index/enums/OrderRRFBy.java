...
public enum OrderRRFBy {
    ...
    TEXT_RANK, // First Ordered By Text_Rank; then ordered by rrf_score (text_rank preferred, then relevance)
    SIMILARITY, // First Ordered by Similarity; then ordered by rrf_score; (similarity preferred, then relevance)
