...
public class PostgresEndpoint extends Endpoint {
  ...
  public PostgresEndpoint(String tableName, EmbeddingEndpoint embeddingEndpoint) {
    ...
    public PostgresEndpoint(String tableName, EmbeddingEndpoint embeddingEndpoint, RetryPolicy retryPolicy) {
        super(retryPolicy);
        this.tableName = tableName;
        this.embeddingEndpoint = embeddingEndpoint;
    }

    public PostgresEndpoint(String tableName, String namespace, EmbeddingEndpoint embeddingEndpoint, RetryPolicy retryPolicy) {
        super(retryPolicy);
        this.tableName = tableName;
        this.namespace = namespace;
        this.embeddingEndpoint = embeddingEndpoint;
