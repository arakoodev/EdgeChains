...
public class ChunkerTest {
    ...
    public void chunker_ByChunkSizeWithEmptyInput_ReturnEmptyArray(TestInfo testInfo) throws Exception {
    ...
    public void chunker_BySentenceWithEmptyInput_ReturnEmptyArray(TestInfo testInfo) throws Exception {
