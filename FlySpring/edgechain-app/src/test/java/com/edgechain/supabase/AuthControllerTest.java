...
public class AuthControllerTest {
    ...
    @InjectMocks
    private SupabaseController supabaseController;
    ...
    public void authController_SignupWithValidCredential_ReturnSupabaseUser(TestInfo testInfo) throws Exception {
    ...
    public void authController_SignupWithExistingEmail_ThrowSupabaseUserExistException(TestInfo testInfo)
            throws Exception {
        ...
        when(userRepository.findByEmail(testCredential.getEmail())).thenReturn(Optional.of(existingUser));

        // Call the signup method of UserServiceImpl
        assertThrows(SupabaseUserExistException.class, () -> {
    ...
    public void authController_LoginWithInvalidCredential_ThrowSupabaseAuthException(TestInfo testInfo)
            throws Exception {
    ...
    public void authController_RefreshTokenWithValidRefreshToken_ReturnAuthenticatedResponse(TestInfo testInfo)
            throws Exception {
    ...
    public void authController_RefreshTokenWithInvalidRefreshToken_ThrowSupabaseAuthException(TestInfo testInfo)
            throws Exception {
        ...
        assertThrows(SupabaseAuthException.class, () -> {
