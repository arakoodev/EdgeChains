...
public class PluginParserTest {
    ...
    public void pluginParser_ParseNoAction_ReturnsExpectedValue(TestInfo testInfo) throws Exception {
        ...
        String response = "{ \"choices\": [{ \"text\": \"Action Input: https://example.com/endpoint\" }, { \"text\": \"Action Input: http://test.com\" }] }";
    ...
    public void pluginParser_GetFinalAnswer_ReturnsExpectedValue(TestInfo testInfo) throws Exception {
        ...
        // choice
        String response = "{ \"choices\": [{ \"text\": \"Final Answer: Success\" }, { \"text\": \"Action Input: https://example.com/endpoint\" }, { \"text\": \"Not a Final Answer\" }] }";
    ...
    public void pluginParser_GetFinalAnswerNotFound_ReturnsNull(TestInfo testInfo) throws Exception {
        ...
        // Sample input response in JSON format
        String response = "{ \"choices\": [{ \"text\": \"Action Input: https://example.com/endpoint\" }, { \"text\": \"Not a Final Answer\" }] }";
