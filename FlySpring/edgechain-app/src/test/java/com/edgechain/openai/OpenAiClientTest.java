...
public class OpenAiClientTest {
    ...
    public void testOpenAiClient_Embeddings() throws InterruptedException {
        ...
        /** Request OpenAi Embeddings; it's giving me an error
         * 1st ==> 3 second
         * 2nd ===> 3 x 2 = 6 seconds
         * 3rd ===> 6 x 2 = 12 Seconds
         */

        String input = "Hey, we are building LLM using Spring and Java";
        OpenAiEmbeddingRequest embeddingRequest = new OpenAiEmbeddingRequest(endpoint.getModel(), input);
        TestObserver<OpenAiEmbeddingResponse> test = new OpenAiClient(endpoint).createEmbeddings(embeddingRequest).getScheduledObservable().test();
