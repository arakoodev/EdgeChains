...
public class ProjectSetup {
    ...
    private String initscriptDir = userHome + separator + ".gradle" + separator 
                                    + "init.d" + separator + "flyfly.gradle";
    ...
    public void addAutorouteJar() throws IOException{
        ...
        if(!autorouteFile.exists() 
            || (autorouteFile.exists() && autorouteFile.delete()) )
