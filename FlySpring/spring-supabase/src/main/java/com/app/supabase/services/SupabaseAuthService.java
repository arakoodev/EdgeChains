...
public class SupabaseAuthService {
    ...
    public SupabaseUser signUpWithEmail(Credential credential) {
        try {
            ...
            ResponseEntity<SupabaseUser> response = restTemplate.exchange(path, HttpMethod.POST, requestEntity, SupabaseUser.class);
    ...
    public AuthenticatedResponse signInWithEmail(Credential credential) {
        try {
            ...
            ResponseEntity<AuthenticatedResponse> response = restTemplate.exchange(path, HttpMethod.POST, requestEntity, AuthenticatedResponse.class);
    ...
    public SupabaseUser getUser(String accessToken) {
        try {
            ...
            ResponseEntity<SupabaseUser> response = restTemplate.exchange(
                    path, HttpMethod.GET, requestEntity, SupabaseUser.class);
