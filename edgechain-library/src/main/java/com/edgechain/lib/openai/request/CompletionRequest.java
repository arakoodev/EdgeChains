...
public class CompletionRequest {
    ...
    public CompletionRequest(String prompt, String model, Double temperature, Integer max_tokens, Double top_p, Double frequency_penalty, Double presence_penalty) {
        this.prompt = prompt;
        this.model = model;
    ...
    public static class CompletionRequestBuilder {
        ...
        public CompletionRequest build(){
            return new CompletionRequest(this.prompt,this.model,this.temperature,this.max_tokens,this.top_p,this.frequency_penalty,this.presence_penalty);
        }
    }
