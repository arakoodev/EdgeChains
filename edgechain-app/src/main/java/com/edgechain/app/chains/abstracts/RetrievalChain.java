...
public abstract class RetrievalChain {
    ...
    public RetrievalChain(Endpoint embeddingEndpoint, Endpoint indexEndpoint, OpenAiService openAiService, IndexService indexService) {
    ...
    public RetrievalChain(Endpoint embeddingEndpoint, Endpoint indexEndpoint, Endpoint chatEndpoint, OpenAiService openAiService, PromptService promptService, IndexService indexService) {
        this.embeddingEndpoint = embeddingEndpoint;
        this.indexEndpoint = indexEndpoint;
