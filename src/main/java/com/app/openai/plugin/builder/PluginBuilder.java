...
public class PluginBuilder {
    ...
    public static Observable<String> requestAPI(LLMService llmService, Endpoint pluginAPI, Endpoint specAPI, String query) {
        ...
        // Use Plugin Service
        PluginService pluginService = new PluginService(llmService, pluginResponse, new CompletionPrompt(pluginResponse).getPrompt(), query);

        return pluginService.request();
    }

    public static Observable<String> requestAPI(LLMService llmService, Endpoint pluginAPI, Endpoint specAPI, PromptTemplate promptTemplate, String query) {
        ...
        // Use Plugin Service
        PluginService pluginService = new PluginService(llmService, pluginResponse, promptTemplate.getPrompt(), query);

        return pluginService.request();
    }

    public static Observable<String> requestJSON(LLMService llmService, PluginJSONParser pluginJSONParser, String query)  {
        try{
    ...
    public static Observable<String> requestJSON(LLMService llmService, PluginJSONParser pluginJSONParser, PromptTemplate promptTemplate, String query) {
        try{
