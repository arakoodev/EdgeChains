...
public class PluginService {
    ...
    public PluginService(LLMService llmService, PluginResponse pluginResponse, String initialPrompt, String query) {
...
//                         Step 8: Fetch JSON Response from URLs extracted via ActionInput;
        ...
        ).doWhileLoop(terminateWhileLoop::get).getObservable();


    }

    private String initializePlugin(LLMService llmService, PluginResponse pluginResponse, StringBuilder prompt) {
        try {
