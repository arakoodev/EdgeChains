...
public class BuilderController {
  ...
  public Flux<? extends ResponseEntity<?>> createChatCompletionFlux(
      @RequestParam("query") String query) {
    return ArkResponse.fromObservable(
            builderService.openAIWithWiki(query).getScheduledObservableWithoutRetry(),
