...
public class JSONPluginConstants {
  ...
  public static String calculatorPluginJSON =
      "{\n"
          ...
          + "  \"description_for_human\": \"Plugin for performing basic arithmetic operations like"
          + " addition, subtraction, multiplication, division, power, and square root.\",\n"
          + "  \"description_for_model\": \"Use the Calculator plugin to perform basic arithmetic"
          + " operations, including addition (+), subtraction (-), multiplication (*), division"
          + " (/), power (^), and square root (√). Provide the numbers and the operation symbol in"
          + " your query, and the plugin will return the calculated result. The calculator works"
          + " best with clear and concise queries.\\n"
  ...
  public static String calculatorSpecJSON =
      "{\n"
          ...
          + "    \"description\": \"A plugin that allows the user to perform basic arithmetic"
          + " operations like addition, subtraction, multiplication, division, power, and square"
          + " root.\",\n"
          + "    \"version\": \"v1\"\n"
          + "  },\n"
          + "  \"servers\": [\n"
