...
import { ERR_INVALID_ARG_TYPE, ERR_INVALID_THIS, ERR_UNKNOWN_ENCODING } from "./internal_errors";
...
function write(this: StringDecoder, buf: ArrayBufferView | DataView | string): string {
    ...
    if (!ArrayBuffer.isView(buf)) {
        throw new ERR_INVALID_ARG_TYPE("buf", ["Buffer", "TypedArray", "DataView", "string"], buf);
    }
