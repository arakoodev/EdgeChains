...
import { validateAbortSignal, validateBoolean, validateFunction } from "./validators";

import * as process from "./process";

import { spliceOne } from "./internal_utils";

import * as async_hooks from "./async_hooks";
const { AsyncResource } = async_hooks;

import { inspect } from "./internal_inspect";
...
export class EventEmitterAsyncResource extends EventEmitter {
    ...
    emit(event: string | symbol, ...args: any[]): void {
        ...
        Reflect.apply(this.#asyncResource.runInAsyncScope, this.#asyncResource, args);
    }
}
...
export function setMaxListeners(n = defaultMaxListeners, ...eventTargets: any[]) {
