...
let DiffieHellman = function (this: DiffieHellman, sizeOrKey: number|ArrayLike,
  ...
  return this;
} as any as { new (sizeOrKey: number|ArrayLike, keyEncoding?: number|string,
                   generator?: number|ArrayLike, genEncoding?: string): DiffieHellman; };
...
function dhComputeSecret(this: DHLike, key: ArrayLike, inEnc?: string,
