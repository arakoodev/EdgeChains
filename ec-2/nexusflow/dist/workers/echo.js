...
class EchoWorker extends StreamAwareBullMQWorker {
    ...
    async processor(job) {
        ...
        if (!inputStream || !outputStream)
            throw new Error("missing stream names");
        ...
        while (true) {
            const messages = await redisClient.xreadgroup("GROUP", groupName, consumerName, "COUNT", 1, "BLOCK", 2000, "STREAMS", inputStream, ">");
